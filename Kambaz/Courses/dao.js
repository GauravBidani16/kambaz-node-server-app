...
export const findAllCourses = () => model.find().exec();

export const findCourseById = (courseId) => model.findById(courseId).exec();

export function updateCourse(courseId, courseUpdates) {
  return model.updateOne({ _id: courseId }, { $set: courseUpdates }).exec();
}
